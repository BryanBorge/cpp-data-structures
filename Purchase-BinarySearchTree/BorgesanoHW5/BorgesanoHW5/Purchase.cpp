...
// Function: Purchase operator== overload
//
// Purpose: Overload comparison operator to return true if the 
//			value of the item names are equal and false otherwise
//
// Update Information
// ------------------
// 
...
// Function: Purchase operator< overload
//
// Purpose: Overload less than operator to return true if the 
//			value of the LHS item name is less than the value
//          of the RHS item name and false other wise
//
// Update Information
// ------------------
// 
...
{
	if (*lhs.m_itemName < *rhs.m_itemName)
		return true;
	else
		return false;
}
...
// Function: Purchase operator> overload
//
// Purpose: Overload greater than operator to return true if the 
//			value of the LHS item name is greater than the value
//          of the RHS item name and false other wise
//
// Update Information
// ------------------
